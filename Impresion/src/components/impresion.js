    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.title}>Blutooth encendido: {this.state.bleOpend?"SI":"NO"} <Text>Active antes de escanear</Text> </Text>
                <View>
                ...
                <Text  style={styles.title}>Dispositivo conectado: <Text style={{color:"blue"}}>{!this.state.name ? 'Ninguno' : this.state.name}</Text></Text>
                <Text  style={styles.title}>Toque un dispotivo para conectar</Text>
...
/*<Button style={{display:'none'}} onPress={()=>{
                        this.impresion();
                    }} title="Imprimir"/>
                    <View style={styles.btn}>
                <Button style={{display:'none'}} onPress={async () => {
                 await BluetoothEscposPrinter.printerInit();
                    await  BluetoothEscposPrinter.printText("I am an english\r\n\r\n sfsfd", {});
                }} title="Print Text"/>
            </View>
            <View style={{display:'none'}} style={styles.btn}>
